    ...
    def on_initialize(self):
        ...
        with tf.device (models_opt_device):
            if 'df' in archi_type:
                ...
                self.inter_AB = model_archi.Inter(in_ch=encoder_out_ch, ae_ch=ae_dims*2, ae_out_ch=ae_dims*4, name='inter_AB')
                self.inter_B  = model_archi.Inter(in_ch=encoder_out_ch, ae_ch=ae_dims*2, ae_out_ch=ae_dims*4, name='inter_B')
